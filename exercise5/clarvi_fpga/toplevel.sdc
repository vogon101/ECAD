...
set_false_path -from [get_ports {VERSION_n}]
set_false_path -to [get_ports {LCD_R_out*}]
set_false_path -to [get_ports {LCD_G_out*}]
set_false_path -to [get_ports {LCD_B_out*}]
set_false_path -to [get_ports {LCD_HSYNC}]
set_false_path -to [get_ports {LCD_VSYNC}]
set_false_path -to [get_ports {LCD_DEN}]
